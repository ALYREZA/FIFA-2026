...
<div class="space-y-6">
	<div>
		<h1 class="text-2xl font-bold text-white">Knockout bracket</h1>
		<p class="mt-1 text-sm text-slate-400">
			Your bracket is built from match predictions. Picks must stay consistent across rounds.
		</p>
	</div>

	{#if data.bracket.length === 0}
		<p class="text-slate-500">No knockout matches yet.</p>
	{:else}
		<div class="space-y-4">
